...
{
    ST1 |= _0002_SAU_CH1_STOP_TRG_ON;    /* disable UART2 receive operation */
    ...
    SOE1 &= ~_0002_SAU_CH1_OUTPUT_ENABLE;    /* disable UART2 output */
    /* Set RxD2 pin */
    PM1 |= 0x10U;
}
